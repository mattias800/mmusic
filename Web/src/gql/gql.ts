...
type Documents = {
    ...
    "\n  fragment ArtistServerStatus_Artist on Artist {\n    id\n    serverStatus {\n      id\n      result {\n        __typename\n        ... on ArtistServerStatusResultBase {\n          releasesVisible\n          topTracksVisible\n        }\n        ... on ArtistServerStatusImportingArtistReleases {\n          totalNumReleaseGroupsBeingImported\n          numReleaseGroupsFinishedImporting\n        }\n      }\n    }\n  }\n": typeof types.ArtistServerStatus_ArtistFragmentDoc,
...
const documents: Documents = {
    ...
    "\n  fragment ArtistNotInLibraryPanel_Artist on Artist {\n    id\n    name\n    ...ArtistHeader_Artist\n    ...ArtistInLibraryButton_Artist\n    ...ArtistNotInLibraryTopTracks_Artist\n  }\n": types.ArtistNotInLibraryPanel_ArtistFragmentDoc,
    ...
    "\n  fragment ArtistServerStatus_Artist on Artist {\n    id\n    serverStatus {\n      id\n      result {\n        __typename\n        ... on ArtistServerStatusResultBase {\n          releasesVisible\n          topTracksVisible\n        }\n        ... on ArtistServerStatusImportingArtistReleases {\n          totalNumReleaseGroupsBeingImported\n          numReleaseGroupsFinishedImporting\n        }\n      }\n    }\n  }\n": types.ArtistServerStatus_ArtistFragmentDoc,
