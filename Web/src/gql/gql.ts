...
type Documents = {
    ...
    "\n  fragment ArtistInLibraryButton_MbArtist on MbArtist {\n    id\n    serverAvailability {\n      id\n      isInServerLibrary\n    }\n  }\n": typeof types.ArtistInLibraryButton_MbArtistFragmentDoc,
...
const documents: Documents = {
    ...
    "\n  fragment ArtistInLibraryButton_MbArtist on MbArtist {\n    id\n    serverAvailability {\n      id\n      isInServerLibrary\n    }\n  }\n": types.ArtistInLibraryButton_MbArtistFragmentDoc,
    ...
    "\n  fragment ArtistCard_MbArtist on MbArtist {\n    id\n    name\n    listeners\n    images {\n      artistThumb\n    }\n  }\n": types.ArtistCard_MbArtistFragmentDoc,
    "\n  query ArtistAlbumList($artistId: ID!) {\n    musicBrainz {\n      artist {\n        byId(id: $artistId) {\n          id\n          albums {\n            id\n            firstReleaseDate\n            ...AlbumCard_ReleaseGroup\n          }\n        }\n      }\n    }\n  }\n": types.ArtistAlbumListDocument,
    "\n  fragment ArtistHeader_MbArtist on MbArtist {\n    id\n    name\n    listeners\n    images {\n      artistBackground\n    }\n  }\n": types.ArtistHeader_MbArtistFragmentDoc,
    "\n  fragment ArtistPanel_MbArtist on MbArtist {\n    id\n    name\n    ...ArtistHeader_MbArtist\n    ...TopArtistTracks_MbArtist\n    ...ArtistInLibraryButton_MbArtist\n  }\n": types.ArtistPanel_MbArtistFragmentDoc,
    "\n  query ArtistSingleList($artistId: ID!) {\n    musicBrainz {\n      artist {\n        byId(id: $artistId) {\n          id\n          singles {\n            id\n            firstReleaseDate\n            ...AlbumCard_ReleaseGroup\n          }\n        }\n      }\n    }\n  }\n": types.ArtistSingleListDocument,
    "\n  fragment TopArtistTrackItem_LastFmTrack on LastFmTrack {\n    id\n    playCount\n    summary\n    recording {\n      id\n      title\n      length\n      ...RecordingPlayButton_Recording\n      relations {\n        attributes\n        url {\n          id\n          resource\n        }\n        direction\n        end\n        begin\n        typeId\n        targetType\n        type\n      }\n      mainAlbum {\n        id\n        title\n        coverArtUri\n        releaseGroup {\n          id\n        }\n      }\n    }\n  }\n": types.TopArtistTrackItem_LastFmTrackFragmentDoc,
    "\n  fragment TopArtistTracks_MbArtist on MbArtist {\n    id\n    topTracks {\n      id\n      ...TopArtistTrackItem_LastFmTrack\n    }\n  }\n": types.TopArtistTracks_MbArtistFragmentDoc,
