...
export type LibraryCacheTrackUpdated = {
  __typename?: 'LibraryCacheTrackUpdated';
  track: Track;
};
...
export type Subscription = {
  ...
  libraryCacheTrackUpdated: LibraryCacheTrackUpdated;
  ping: Ping;
