...
export type ArtistServerStatusSearchRoot = {
  __typename?: 'ArtistServerStatusSearchRoot';
  byArtistId: ArtistServerStatus;
};


export type ArtistServerStatusSearchRootByArtistIdArgs = {
  artistId: Scalars['ID']['input'];
};
...
export type Query = {
  ...
  artistServerStatus: ArtistServerStatusSearchRoot;
...
export type ArtistPanel_ArtistFragment = (
  ...
  & { ' $fragmentRefs'?: { 'TopArtistTracks_ArtistFragment': TopArtistTracks_ArtistFragment;'ArtistNotInLibraryTopTracks_ArtistFragment': ArtistNotInLibraryTopTracks_ArtistFragment } }
