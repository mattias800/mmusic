...
export type QueuesPage_DownloadQueueUpdatedSubscription = { __typename?: 'Subscription', downloadQueueUpdated: { __typename?: 'DownloadQueueState', queueLength: number, items: Array<{ __typename?: 'DownloadQueueItem', artistId: string, releaseFolderName: string, queueKey?: string | null }> } };

export type QueuesPage_CurrentDownloadUpdatedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type QueuesPage_CurrentDownloadUpdatedSubscription = { __typename?: 'Subscription', currentDownloadUpdated?: { __typename?: 'DownloadProgress', artistId: string, releaseFolderName: string, status: DownloadStatus, totalTracks: number, completedTracks: number, errorMessage?: string | null, artistName?: string | null, releaseTitle?: string | null, coverArtUrl?: string | null, currentTrackProgressPercent?: number | null, currentDownloadSpeedKbps?: number | null } | null };

export type QueuesPage_ArtistImportQueueUpdatedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type QueuesPage_ArtistImportQueueUpdatedSubscription = { __typename?: 'Subscription', artistImportQueueUpdated: { __typename?: 'ArtistImportQueueState', queueLength: number, items: Array<{ __typename?: 'ArtistImportQueueItem', artistName: string, songTitle?: string | null, queueKey?: string | null }> } };

export type QueuesPage_CurrentArtistImportUpdatedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type QueuesPage_CurrentArtistImportUpdatedSubscription = { __typename?: 'Subscription', currentArtistImportUpdated: { __typename?: 'ArtistImportProgress', artistName: string, songTitle?: string | null, totalReleases: number, completedReleases: number, errorMessage?: string | null, statusInfo: { __typename?: 'ArtistImportStatusInfo', id: ArtistImportStatus, text: string } } };
...
export type DownloadOverviewQueryQuery = { __typename?: 'Query', downloads: { __typename?: 'DownloadsSearchRoot', downloadQueue: { __typename?: 'DownloadQueueState', queueLength: number, items: Array<{ __typename?: 'DownloadQueueItem', id: string, artistId: string, releaseFolderName: string }> }, currentDownload?: { __typename?: 'DownloadProgress', id: string, artistId: string, releaseFolderName: string, status: DownloadStatus, totalTracks: number, completedTracks: number, errorMessage?: string | null } | null } };
...
export type CurrentDownloadUpdatedSubSubscription = { __typename?: 'Subscription', currentDownloadUpdated?: { __typename?: 'DownloadProgress', id: string, artistId: string, releaseFolderName: string, status: DownloadStatus, totalTracks: number, completedTracks: number, errorMessage?: string | null } | null };
