...
export type AlbumHeader_ReleaseFragment = { __typename?: 'Release', id: string, title: string, coverArtUri: string, year?: string | null, artists: Array<{ __typename?: 'Artist', id: string, name: string }> } & { ' $fragmentName'?: 'AlbumHeader_ReleaseFragment' };
