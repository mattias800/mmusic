...
export type CancelCurrentDownloadError = {
  __typename?: 'CancelCurrentDownloadError';
  message: Scalars['String']['output'];
};

export type CancelCurrentDownloadInput = {
  artistId: Scalars['String']['input'];
};

export type CancelCurrentDownloadResult = CancelCurrentDownloadError | CancelCurrentDownloadSuccess;

export type CancelCurrentDownloadSuccess = {
  __typename?: 'CancelCurrentDownloadSuccess';
...
export type MoveCurrentDownloadToBackError = {
  __typename?: 'MoveCurrentDownloadToBackError';
  message: Scalars['String']['output'];
};

export type MoveCurrentDownloadToBackResult = MoveCurrentDownloadToBackError | MoveCurrentDownloadToBackSuccess;

export type MoveCurrentDownloadToBackSuccess = {
  __typename?: 'MoveCurrentDownloadToBackSuccess';
  downloadQueue: DownloadQueueState;
};
...
export type Mutation = {
  ...
  cancelCurrentDownload: CancelCurrentDownloadResult;
  ...
  moveCurrentDownloadToBack: MoveCurrentDownloadToBackResult;
...
export type MutationCancelCurrentDownloadArgs = {
  input: CancelCurrentDownloadInput;
};
...
export type MutationCreateLibraryManifestArgs = {
  input: CreateLibraryManifestInput;
};
...
export type QueuesPage_CurrentDownloadUpdatedSubscription = { __typename?: 'Subscription', currentDownloadUpdated?: { __typename?: 'DownloadProgress', id: string, artistId: string, releaseFolderName: string, status: DownloadStatus, totalTracks: number, completedTracks: number, errorMessage?: string | null, artistName?: string | null, releaseTitle?: string | null, coverArtUrl?: string | null, currentTrackProgressPercent?: number | null, currentDownloadSpeedKbps?: number | null } | null };
...
export type CancelCurrentDownloadMutationVariables = Exact<{
  artistId: Scalars['String']['input'];
}>;


export type CancelCurrentDownloadMutation = { __typename?: 'Mutation', cancelCurrentDownload: { __typename: 'CancelCurrentDownloadError', message: string } | { __typename: 'CancelCurrentDownloadSuccess', ok: boolean } };

export type MoveCurrentToBackMutationVariables = Exact<{ [key: string]: never; }>;


export type MoveCurrentToBackMutation = { __typename?: 'Mutation', moveCurrentDownloadToBack: { __typename: 'MoveCurrentDownloadToBackError', message: string } | { __typename: 'MoveCurrentDownloadToBackSuccess', downloadQueue: { __typename?: 'DownloadQueueState', id: string, queueLength: number, items: Array<{ __typename?: 'DownloadQueueItem', id: string, artistId: string, releaseFolderName: string }> } } };
...
export type SettingsPageQuery = { __typename?: 'Query', serverSettings: (
    { __typename?: 'ServerSettings' }
    & { ' $fragmentRefs'?: { 'LibraryPathForm_ServerSettingsFragment': LibraryPathForm_ServerSettingsFragment } }
  ) };
...
export type DownloadOverviewQueryQuery = { __typename?: 'Query', downloads: { __typename?: 'DownloadsSearchRoot', downloadQueue: { __typename?: 'DownloadQueueState', id: string, queueLength: number, items: Array<{ __typename?: 'DownloadQueueItem', id: string, artistId: string, releaseFolderName: string }> }, currentDownload?: { __typename?: 'DownloadProgress', id: string, artistId: string, releaseFolderName: string, status: DownloadStatus, totalTracks: number, completedTracks: number, errorMessage?: string | null, currentDownloadSpeedKbps?: number | null } | null } };
...
export type CurrentDownloadUpdatedSubSubscription = { __typename?: 'Subscription', currentDownloadUpdated?: { __typename?: 'DownloadProgress', id: string, artistId: string, releaseFolderName: string, status: DownloadStatus, totalTracks: number, completedTracks: number, errorMessage?: string | null, currentDownloadSpeedKbps?: number | null } | null };
...
export type LibraryPathForm_ServerSettingsFragment = { __typename?: 'ServerSettings', id: string, libraryPath: string, storageStats?: { __typename?: 'StorageStats', totalDiskBytes?: any | null, availableFreeBytes?: any | null, librarySizeBytes: any } | null } & { ' $fragmentName'?: 'LibraryPathForm_ServerSettingsFragment' };
...
export type ChangeFolder_CreateLibraryManifestMutationVariables = Exact<{
  path: Scalars['String']['input'];
}>;


export type ChangeFolder_CreateLibraryManifestMutation = { __typename?: 'Mutation', createLibraryManifest: { __typename?: 'CreateLibraryManifestError', message: string } | { __typename?: 'CreateLibraryManifestSuccess', created: boolean } };
...
export const CancelCurrentDownloadDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CancelCurrentDownload"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"artistId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"cancelCurrentDownload"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"artistId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"artistId"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"CancelCurrentDownloadSuccess"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"ok"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"CancelCurrentDownloadError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]} as unknown as DocumentNode<CancelCurrentDownloadMutation, CancelCurrentDownloadMutationVariables>;
export const MoveCurrentToBackDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MoveCurrentToBack"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"moveCurrentDownloadToBack"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"MoveCurrentDownloadToBackSuccess"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"downloadQueue"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"queueLength"}},{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"artistId"}},{"kind":"Field","name":{"kind":"Name","value":"releaseFolderName"}}]}}]}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"MoveCurrentDownloadToBackError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]} as unknown as DocumentNode<MoveCurrentToBackMutation, MoveCurrentToBackMutationVariables>;
export const SettingsPageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SettingsPage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"serverSettings"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"LibraryPathForm_ServerSettings"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"LibraryPathForm_ServerSettings"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ServerSettings"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"libraryPath"}},{"kind":"Field","name":{"kind":"Name","value":"storageStats"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"totalDiskBytes"}},{"kind":"Field","name":{"kind":"Name","value":"availableFreeBytes"}},{"kind":"Field","name":{"kind":"Name","value":"librarySizeBytes"}}]}}]}}]} as unknown as DocumentNode<SettingsPageQuery, SettingsPageQueryVariables>;
...
export const ChangeFolder_CreateLibraryManifestDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ChangeFolder_CreateLibraryManifest"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"path"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createLibraryManifest"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"libraryPath"},"value":{"kind":"Variable","name":{"kind":"Name","value":"path"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"CreateLibraryManifestSuccess"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"created"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"CreateLibraryManifestError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]} as unknown as DocumentNode<ChangeFolder_CreateLibraryManifestMutation, ChangeFolder_CreateLibraryManifestMutationVariables>;
