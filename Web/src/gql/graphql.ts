...
export type CurrentDownloadUpdatedSubSubscription = { __typename?: 'Subscription', currentDownloadUpdated?: { __typename?: 'DownloadProgress', id: string, artistId: string, releaseFolderName: string, status: DownloadStatus, totalTracks: number, completedTracks: number, errorMessage?: string | null, currentDownloadSpeedKbps?: number | null, currentProvider?: string | null, currentProviderIndex: number, totalProviders: number } | null };
