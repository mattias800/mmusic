...
export type ArtistAlbumList_ArtistFragment = { __typename?: 'Artist', id: string, albums: Array<(
    { __typename?: 'Release', id: string, date?: string | null, country?: string | null, releaseGroup?: { __typename?: 'ReleaseGroup', id: string, primaryType?: string | null, secondaryTypes: Array<string> } | null }
...
export type ArtistPanel_ArtistFragment = (
  ...
  & { ' $fragmentRefs'?: { 'ArtistAlbumList_ArtistFragment': ArtistAlbumList_ArtistFragment } }
