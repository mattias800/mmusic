...
export type LikedSongRow_LikedSongFragment = { __typename?: 'LikedSong', id: string, recording?: { __typename?: 'Recording', id: string, title: string, length?: number | null, artists: Array<{ __typename?: 'Artist', id: string, name: string }>, mainAlbum: { __typename?: 'Release', id: string, title: string, coverArtUri: string } } | null } & { ' $fragmentName'?: 'LikedSongRow_LikedSongFragment' };
