...
export type ArtistHeader_ArtistFragment = { __typename?: 'Artist', id: string, name: string } & { ' $fragmentName'?: 'ArtistHeader_ArtistFragment' };

export type ArtistPanel_ArtistFragment = (
  { __typename?: 'Artist', id: string, name: string }
  & { ' $fragmentRefs'?: { 'ArtistHeader_ArtistFragment': ArtistHeader_ArtistFragment;'ArtistAlbumList_ArtistFragment': ArtistAlbumList_ArtistFragment } }
