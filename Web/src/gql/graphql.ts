...
export type AdminOverviewTabQueryQuery = { __typename?: 'Query', serverLibrary: (
  ...
  ), serverSettings: { __typename?: 'ServerSettings', storageStats?: (
      { __typename?: 'StorageStats' }
      & { ' $fragmentRefs'?: { 'DiskUsagePanel_StorageStatsFragment': DiskUsagePanel_StorageStatsFragment } }
    ) | null } };
...
export type AlbumTrackList_ReleaseFragment = { __typename?: 'Release', id: string, title: string, folderName: string, discCount: number, artist: { __typename?: 'Artist', id: string }, discs: Array<{ __typename?: 'Disc', discNumber: number, title?: string | null, tracks: Array<(
...
export type ArtistImportStatusInfo_BackgroundSubscription = { __typename?: 'Subscription', artistImportBackgroundProgress: { __typename?: 'ArtistImportBackgroundProgress', artistId: string, message: string, percentage: number, hasError: boolean } };
...
export type DownloadOverviewQueryQuery = { __typename?: 'Query', downloads: { __typename?: 'DownloadsSearchRoot', downloadQueue: { __typename?: 'DownloadQueueState', id: string, queueLength: number, items: Array<{ __typename?: 'DownloadQueueItem', id: string, artistId: string, artistName?: string | null, releaseFolderName: string, releaseTitle?: string | null }> }, downloadSlots: Array<{ __typename?: 'DownloadSlotInfo', id: number, isActive: boolean, isWorking: boolean, status?: string | null, currentWork?: { __typename?: 'DownloadQueueItem', artistId: string, artistName?: string | null, releaseFolderName: string, releaseTitle?: string | null } | null, currentProgress?: { __typename?: 'DownloadProgress', id: string, artistId: string, artistName?: string | null, releaseFolderName: string, releaseTitle?: string | null, status: DownloadStatus, totalTracks: number, completedTracks: number, errorMessage?: string | null, currentDownloadSpeedKbps?: number | null, currentProvider?: string | null, currentProviderIndex: number, totalProviders: number } | null }> } };
...
export type LibraryPathForm_ServerSettingsFragment = (
  { __typename?: 'ServerSettings', id: string, libraryPath: string }
...
export type ArtistImportBackgroundQueueUpdatedSubSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type ArtistImportBackgroundQueueUpdatedSubSubscription = { __typename?: 'Subscription', artistImportBackgroundQueueUpdated: { __typename?: 'ArtistImportBackgroundQueueState', queueLength: number } };
...
export type DiskUsagePanel_StorageStatsFragment = { __typename?: 'StorageStats', availableFreeBytes?: any | null, estimatedTotalLibrarySizeBytes: any, librarySizeBytes: any, totalDiskBytes?: any | null } & { ' $fragmentName'?: 'DiskUsagePanel_StorageStatsFragment' };
...
export const DiskUsagePanel_StorageStatsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"DiskUsagePanel_StorageStats"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"StorageStats"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"availableFreeBytes"}},{"kind":"Field","name":{"kind":"Name","value":"estimatedTotalLibrarySizeBytes"}},{"kind":"Field","name":{"kind":"Name","value":"librarySizeBytes"}},{"kind":"Field","name":{"kind":"Name","value":"totalDiskBytes"}}]}}]} as unknown as DocumentNode<DiskUsagePanel_StorageStatsFragment, unknown>;
...
export const AdminOverviewTabQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AdminOverviewTabQuery"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"serverLibrary"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"ServerLibraryStatisticsHeader_ServerLibrary"}}]}},{"kind":"Field","name":{"kind":"Name","value":"serverSettings"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"storageStats"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"DiskUsagePanel_StorageStats"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ServerLibraryStatisticsHeader_ServerLibrary"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ServerLibrarySearchRoot"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"libraryStatistics"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artistCount"}},{"kind":"Field","name":{"kind":"Name","value":"releaseCount"}},{"kind":"Field","name":{"kind":"Name","value":"trackCount"}},{"kind":"Field","name":{"kind":"Name","value":"isInitialized"}},{"kind":"Field","name":{"kind":"Name","value":"lastUpdated"}}]}},{"kind":"Field","name":{"kind":"Name","value":"allReleases"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"isFullyMissing"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"DiskUsagePanel_StorageStats"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"StorageStats"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"availableFreeBytes"}},{"kind":"Field","name":{"kind":"Name","value":"estimatedTotalLibrarySizeBytes"}},{"kind":"Field","name":{"kind":"Name","value":"librarySizeBytes"}},{"kind":"Field","name":{"kind":"Name","value":"totalDiskBytes"}}]}}]} as unknown as DocumentNode<AdminOverviewTabQueryQuery, AdminOverviewTabQueryQueryVariables>;
...
export const ArtistImportBackgroundQueueUpdatedSubDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"ArtistImportBackgroundQueueUpdatedSub"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artistImportBackgroundQueueUpdated"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"queueLength"}}]}}]}}]} as unknown as DocumentNode<ArtistImportBackgroundQueueUpdatedSubSubscription, ArtistImportBackgroundQueueUpdatedSubSubscriptionVariables>;
