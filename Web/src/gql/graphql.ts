...
export type ArtistImportQueuePanel_QueryQuery = { __typename?: 'Query', artistImportQueue: { __typename?: 'ArtistImportQueueState', queueLength: number, items: Array<{ __typename?: 'ArtistImportQueueItem', artistName: string, songTitle?: string | null }> }, currentArtistImport: { __typename?: 'ArtistImportProgress', artistName: string, songTitle?: string | null, status: ArtistImportStatus, totalReleases: number, completedReleases: number, errorMessage?: string | null } };
