...
export type MovePlaylistItemInput = {
  ...
  playlistId: Scalars['UUID']['input'];
  playlistItemId: Scalars['Int']['input'];
};
...
export type PlaylistHeader_PlaylistFragment = { __typename?: 'Playlist', id: string, name?: string | null, items: Array<{ __typename?: 'PlaylistItem', id: number, coverImageUrl?: string | null }> } & { ' $fragmentName'?: 'PlaylistHeader_PlaylistFragment' };

export type PlaylistPanel_PlaylistFragment = (
  { __typename?: 'Playlist', id: string, name?: string | null, items: Array<{ __typename?: 'PlaylistItem', id: number, title?: string | null, artistName?: string | null, coverImageUrl?: string | null, trackLengthMs?: number | null, track?: (
  ...
  & { ' $fragmentRefs'?: { 'PlaylistHeader_PlaylistFragment': PlaylistHeader_PlaylistFragment } }
