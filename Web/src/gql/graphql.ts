...
export type PlayAlbumButton_ReleaseFragment = { __typename?: 'Release', id: string, folderName: string, coverArtUrl: string, artist: { __typename?: 'Artist', id: string, name: string }, tracks: Array<{ __typename?: 'Track', id: string, title: string, isMissing: boolean }> } & { ' $fragmentName'?: 'PlayAlbumButton_ReleaseFragment' };
