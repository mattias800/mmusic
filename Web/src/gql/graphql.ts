...
export type AlbumCard_ReleaseFragment = { __typename?: 'Release', id: string, title: string, firstReleaseYear?: string | null, coverArtUrl: string, folderName: string, isFullyMissing: boolean, artist: { __typename?: 'Artist', id: string } } & { ' $fragmentName'?: 'AlbumCard_ReleaseFragment' };
...
export type AlbumPanel_StartDownloadReleaseMutation = { __typename?: 'Mutation', startDownloadRelease: { __typename: 'StartDownloadReleaseSuccess', success: boolean } };
...
export type AlbumTrackList_ReleaseFragment = { __typename?: 'Release', id: string, title: string, folderName: string, artist: { __typename?: 'Artist', id: string }, tracks: Array<(
    { __typename?: 'Track', id: string, title: string, trackLength?: number | null, isMissing: boolean, statistics?: { __typename?: 'LastFmStatistics', listeners: any, playCount: any } | null }
    & { ' $fragmentRefs'?: { 'AlbumTrackTag_TrackFragment': AlbumTrackTag_TrackFragment;'RecordingPlayButton_TrackFragment': RecordingPlayButton_TrackFragment } }
...
export type RefreshArtistTopTracksFromHeaderMutationVariables = Exact<{
  input: RefreshArtistTopTracksInput;
}>;


export type RefreshArtistTopTracksFromHeaderMutation = { __typename?: 'Mutation', refreshArtistTopTracks: { __typename: 'RefreshArtistTopTracksSuccess' } | { __typename: 'RefreshArtistTopTracksUnknownError' } };

export type RefreshArtistLastFmMutationVariables = Exact<{
  artistId: Scalars['String']['input'];
}>;


export type RefreshArtistLastFmMutation = { __typename?: 'Mutation', refreshArtistLastFm: { __typename: 'RefreshArtistLastFmError' } | { __typename: 'RefreshArtistLastFmSuccess' } };

export type ReimportReleaseMutationVariables = Exact<{
  artistId: Scalars['String']['input'];
  folder: Scalars['String']['input'];
}>;


export type ReimportReleaseMutation = { __typename?: 'Mutation', reimportRelease: { __typename: 'ReimportReleaseError' } | { __typename: 'ReimportReleaseSuccess' } };

export type RedownloadReleaseMutationVariables = Exact<{
  artistId: Scalars['String']['input'];
  folder: Scalars['String']['input'];
}>;


export type RedownloadReleaseMutation = { __typename?: 'Mutation', redownloadRelease: { __typename: 'RedownloadReleaseError' } | { __typename: 'RedownloadReleaseSuccess' } };
...
export type ArtistTopTracksForQueueQuery = { __typename?: 'Query', serverLibrary: { __typename?: 'ServerLibrarySearchRoot', artistById?: { __typename?: 'Artist', id: string, topTracks: Array<{ __typename?: 'ArtistTopTrack', title: string, coverArtUrl?: string | null, track?: { __typename?: 'Track', trackNumber: number, release: { __typename?: 'Release', folderName: string, artist: { __typename?: 'Artist', id: string, name: string } } } | null }> } | null } };

export type ArtistReleasesForContextQueryVariables = Exact<{
  artistId: Scalars['ID']['input'];
}>;


export type ArtistReleasesForContextQuery = { __typename?: 'Query', serverLibrary: { __typename?: 'ServerLibrarySearchRoot', artistById?: { __typename?: 'Artist', id: string, releases: Array<{ __typename?: 'Release', folderName: string, title: string }> } | null } };
...
export type TopArtistTrackItem_ArtistTopTrackFragment = { __typename?: 'ArtistTopTrack', title: string, releaseTitle?: string | null, playCount?: any | null, coverArtUrl?: string | null, track?: (
    { __typename?: 'Track', id: string, trackLength?: number | null, trackNumber: number, isMissing: boolean, release: { __typename?: 'Release', id: string, folderName: string, artist: { __typename?: 'Artist', id: string } } }
    & { ' $fragmentRefs'?: { 'AlbumTrackTag_TrackFragment': AlbumTrackTag_TrackFragment } }
...
export type RefreshArtistTopTracksMutationVariables = Exact<{
  input: RefreshArtistTopTracksInput;
}>;


export type RefreshArtistTopTracksMutation = { __typename?: 'Mutation', refreshArtistTopTracks: { __typename: 'RefreshArtistTopTracksSuccess', artist: { __typename?: 'Artist', id: string, topTracks: Array<(
        { __typename?: 'ArtistTopTrack' }
        & { ' $fragmentRefs'?: { 'TopArtistTrackItem_ArtistTopTrackFragment': TopArtistTrackItem_ArtistTopTrackFragment } }
      )> } } | { __typename: 'RefreshArtistTopTracksUnknownError', message: string } };
...
export type DownloadOverview_DownloadStatusFragment = { __typename?: 'Query', areThereAnyUsers: boolean } & { ' $fragmentName'?: 'DownloadOverview_DownloadStatusFragment' };

export type DownloadOverviewQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type DownloadOverviewQueryQuery = { __typename?: 'Query', areThereAnyUsers: boolean };

export type DownloadOverviewSubscriptionSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type DownloadOverviewSubscriptionSubscription = { __typename?: 'Subscription', ping: { __typename?: 'Ping', id: string } };

export type DownloadStatus_DownloadStatusFragment = { __typename?: 'Query', areThereAnyUsers: boolean } & { ' $fragmentName'?: 'DownloadStatus_DownloadStatusFragment' };
...
export type RecordingPlayButton_TrackFragment = { __typename?: 'Track', id: string, title: string, release: { __typename?: 'Release', id: string, folderName: string, artist: { __typename?: 'Artist', id: string } } } & { ' $fragmentName'?: 'RecordingPlayButton_TrackFragment' };
...
export const RefreshArtistTopTracksFromHeaderDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RefreshArtistTopTracksFromHeader"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"RefreshArtistTopTracksInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"refreshArtistTopTracks"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}}]}}]}}]} as unknown as DocumentNode<RefreshArtistTopTracksFromHeaderMutation, RefreshArtistTopTracksFromHeaderMutationVariables>;
export const RefreshArtistLastFmDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RefreshArtistLastFm"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"artistId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"refreshArtistLastFm"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"artistId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"artistId"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}}]}}]}}]} as unknown as DocumentNode<RefreshArtistLastFmMutation, RefreshArtistLastFmMutationVariables>;
export const ReimportReleaseDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ReimportRelease"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"artistId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"folder"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"reimportRelease"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"artistId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"artistId"}}},{"kind":"Argument","name":{"kind":"Name","value":"releaseFolderName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"folder"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}}]}}]}}]} as unknown as DocumentNode<ReimportReleaseMutation, ReimportReleaseMutationVariables>;
export const RedownloadReleaseDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RedownloadRelease"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"artistId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"folder"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"redownloadRelease"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"artistId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"artistId"}}},{"kind":"Argument","name":{"kind":"Name","value":"releaseFolderName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"folder"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}}]}}]}}]} as unknown as DocumentNode<RedownloadReleaseMutation, RedownloadReleaseMutationVariables>;
...
export const ArtistReleasesForContextDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ArtistReleasesForContext"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"artistId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"serverLibrary"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artistById"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"artistId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"releases"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"folderName"}},{"kind":"Field","name":{"kind":"Name","value":"title"}}]}}]}}]}}]}}]} as unknown as DocumentNode<ArtistReleasesForContextQuery, ArtistReleasesForContextQueryVariables>;
...
export const RefreshArtistTopTracksDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RefreshArtistTopTracks"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"RefreshArtistTopTracksInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"refreshArtistTopTracks"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"RefreshArtistTopTracksSuccess"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artist"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"topTracks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"TopArtistTrackItem_ArtistTopTrack"}}]}}]}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"RefreshArtistTopTracksUnknownError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AlbumTrackTag_Track"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Track"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"isMissing"}},{"kind":"Field","name":{"kind":"Name","value":"mediaAvailabilityStatus"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"TopArtistTrackItem_ArtistTopTrack"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ArtistTopTrack"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"releaseTitle"}},{"kind":"Field","name":{"kind":"Name","value":"playCount"}},{"kind":"Field","name":{"kind":"Name","value":"coverArtUrl"}},{"kind":"Field","name":{"kind":"Name","value":"track"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"AlbumTrackTag_Track"}},{"kind":"Field","name":{"kind":"Name","value":"trackLength"}},{"kind":"Field","name":{"kind":"Name","value":"trackNumber"}},{"kind":"Field","name":{"kind":"Name","value":"isMissing"}},{"kind":"Field","name":{"kind":"Name","value":"release"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"folderName"}},{"kind":"Field","name":{"kind":"Name","value":"artist"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]}}]} as unknown as DocumentNode<RefreshArtistTopTracksMutation, RefreshArtistTopTracksMutationVariables>;
