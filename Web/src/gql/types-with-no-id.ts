...
export function hasIdField(type: string): type is TypesWithId {
  const typesWithId: string[] = ['Artist', 'ArtistServerStatus', 'DownloadStatus', 'ExternalRoot', 'LastFmAlbum', 'LastFmArtist', 'LastFmTrack', 'LikedSong', 'MbArtist', 'MbGenre', 'MbLabel', 'MbRecording', 'MbRecordingStreamingServiceInfo', 'MbRelease', 'MbReleaseGroup', 'MbTrack', 'Ping', 'Playlist', 'Release', 'ServerSettings', 'SoulSeekRoot', 'SoulSeekStatus', 'SpotifyPlaylist', 'Track', 'Url', 'User'];
...
export function hasNoIdField(type: string): type is TypesWithNoId {
  const typesWithNoId: string[] = ['ArtistImages', 'ArtistServerStatusImportingArtist', 'ArtistServerStatusImportingArtistReleases', 'ArtistServerStatusNotInLibrary', 'ArtistServerStatusReady', 'ArtistServerStatusUpdatingArtist', 'ArtistServerStatusUpdatingArtistReleases', 'ArtistTopTrack', 'CacheStatistics', 'DownloadsSearchRoot', 'FileSystemSearchRoot', 'ImportPlaylistSearchRoot', 'ImportedRelease', 'LastFmStatistics', 'LastFmTag', 'MbAlbumImages', 'MbLabelInfo', 'MbMedium', 'MbNameCredit', 'MbRelation', 'MusicBrainzArtistSearchRoot', 'MusicBrainzRecordingSearchRoot', 'MusicBrainzReleaseGroupSearchRoot', 'MusicBrainzReleaseSearchRoot', 'MusicBrainzSearchRoot', 'PageInfo', 'PhotosDownloaded', 'PlaylistSearchRoot', 'RecommendationsSearchRoot', 'ServerLibrarySearchRoot', 'SpotifyPlaylistSearchRoot', 'UserSearchRoot', 'UsersConnection', 'UsersEdge'];
