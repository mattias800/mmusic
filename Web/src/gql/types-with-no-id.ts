...
export function hasNoIdField(type: string): type is TypesWithNoId {
  const typesWithNoId: string[] = ['ArtistImages', 'ArtistImportProgress', 'ArtistImportQueueItem', 'ArtistImportQueueState', 'ArtistServerStatusImportingArtist', 'ArtistServerStatusImportingArtistReleases', 'ArtistServerStatusNotInLibrary', 'ArtistServerStatusReady', 'ArtistServerStatusUpdatingArtist', 'ArtistServerStatusUpdatingArtistReleases', 'ArtistTopTrack', 'CacheStatistics', 'FileSystemSearchRoot', 'ImportPlaylistSearchRoot', 'ImportedRelease', 'LastFmStatistics', 'LastFmTag', 'LibraryCacheTrackStatus', 'LibraryReleaseDownloadStatusUpdate', 'MbAlbumImages', 'MbArtistImages', 'MbLabelInfo', 'MbMedium', 'MbNameCredit', 'MbRelation', 'MusicBrainzArtistSearchRoot', 'MusicBrainzRecordingSearchRoot', 'MusicBrainzReleaseGroupSearchRoot', 'MusicBrainzReleaseSearchRoot', 'MusicBrainzSearchRoot', 'PageInfo', 'PlaylistSearchRoot', 'RecommendationsSearchRoot', 'ScoredRelease', 'ServerLibrarySearchRoot', 'SpotifyPlaylistSearchRoot', 'TrackCredit', 'TrackStatistics', 'UserSearchRoot', 'UsersConnection', 'UsersEdge'];
