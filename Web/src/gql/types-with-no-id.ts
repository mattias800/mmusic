...
export type TypesWithNoId =
  | "ArtistAppearsOn"
  | "ArtistAppearsOnRelease"
  | "ArtistConnectedExternalService"
  | "ArtistImages"
  | "ArtistImportBackgroundJob"
  | "ArtistImportBackgroundProgress"
  | "ArtistImportBackgroundQueueState"
  | "ArtistImportHistoryItem"
  | "ArtistImportSearchRoot"
  | "ArtistSearchRoot"
  | "ArtistTopTrack"
  | "CacheStatistics"
  ...
  | "DownloadHistoryItem"
  | "DownloadsSearchRoot"
  | "ExternalServicesSearchRoot"
  | "FileSystemSearchRoot"
  ...
  | "JsonTrackStatistics"
  | "KeyValuePairOfInt32AndDownloadProgress"
  | "LastFmStatistics"
  | "LastFmTag"
  | "LibraryCacheTrackStatus"
  | "LibraryReleaseDownloadStatusUpdate"
  | "ListenBrainzQueryRoot"
  | "MbAlbumImages"
  | "MbArtistImages"
  | "MbLabelInfo"
  | "MbMedium"
  ...
  | "ReleaseServiceConnections"
  | "ScoredRelease"
  | "ServerLibrarySearchRoot"
  | "SharingStatistics"
  | "SimilarArtist"
  | "SlotProgressUpdate"
  | "SlotStatusUpdate"
  | "SpotifyArtistSearchRoot"
  | "SpotifyImage"
...
export type TypesWithId =
  ...
  | "ArtistImportQueueItem"
  | "ArtistImportQueueState"
