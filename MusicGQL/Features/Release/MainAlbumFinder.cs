...
public static class MainAlbumFinder
{
    ...
    public static MbRelease FindMainAlbumForSong(List<MbRelease> releaseList)
    {
        var allAlbums = releaseList.Where(r => r.ReleaseGroup?.PrimaryType == "Album").ToList();
        ...
        var allEps = releaseList.Where(r => r.ReleaseGroup?.PrimaryType == "EP").ToList();
        ...
        var allSingles = releaseList.Where(r => r.ReleaseGroup?.PrimaryType == "Single").ToList();
