...
builder
    ...
    .AddSingleton<MusicGQL.Features.Clients.ClientPresenceService>()
...
.AddTypeExtension<LibrarySubscription>()
    ...
    .AddTypeExtension<UpdatePublicBaseUrlMutation>()
    .AddType<UpdatePublicBaseUrlSuccess>()
    .AddType<UpdatePublicBaseUrlError>()
    .AddTypeExtension<UpdateSoulSeekConnectionSettingsMutation>()
    .AddType<UpdateSoulSeekConnectionSettingsSuccess>()
    .AddType<UpdateSoulSeekConnectionSettingsError>()
    .AddTypeExtension<UpdateProwlarrSettingsMutation>()
    .AddType<UpdateProwlarrSettingsSuccess>()
    .AddType<UpdateProwlarrSettingsError>()
    ...
    .AddTypeExtension<UpdateUserUsernameMutation>()
    .AddType<UpdateUserUsernameSuccess>()
    .AddType<UpdateUserUsernameError>()
    .AddTypeExtension<SetUserPasswordMutation>()
    .AddType<SetUserPasswordSuccess>()
    .AddType<SetUserPasswordError>()
