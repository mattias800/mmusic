...
builder
    ...
    .AddTypeExtension<RefreshArtistLastFmMutation>()
    .AddTypeExtension<ReimportReleaseMutation>()
    .AddTypeExtension<RedownloadReleaseMutation>()
    .AddType<ReimportReleaseSuccess>()
    .AddType<ReimportReleaseError>()
    .AddType<RedownloadReleaseSuccess>()
    .AddType<RedownloadReleaseError>()
    .AddType<RefreshArtistLastFmSuccess>()
    .AddType<RefreshArtistLastFmError>()
