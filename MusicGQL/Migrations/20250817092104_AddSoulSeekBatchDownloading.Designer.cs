...
namespace MusicGQL.Migrations
{
    ...
    [Migration("20250817092104_AddSoulSeekBatchDownloading")]
    partial class AddSoulSeekBatchDownloading
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicGQL.Features.ServerSettings.Db.DbServerSettings", b =>
                {
                    ...
                    b.Property<int>("DownloadSlotCount")
                        .HasColumnType("integer");

                    b.Property<bool>("LastFmTopTracksEnabled")
                    ...
                    b.Property<string>("ListenBrainzApiKey")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<bool>("ListenBrainzTopTracksEnabled")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("SoulSeekBatchDownloadingEnabled")
                        .HasColumnType("boolean");

                    b.Property<int>("SoulSeekNoDataTimeoutSeconds")
                        .HasColumnType("integer");

                    b.Property<int>("SoulSeekSearchTimeLimitSeconds")
                        .HasColumnType("integer");

                    b.Property<bool>("SpotifyTopTracksEnabled")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("MusicGQL.Features.Users.Db.DbUser", b =>
                {
                    ...
                    b.Property<string>("ListenBrainzToken")
                        .HasColumnType("text");

                    b.Property<string>("ListenBrainzUserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MusicGQL.Features.Users.Events.UserListenBrainzCredentialsUpdated", b =>
                {
                    b.HasBaseType("MusicGQL.Db.Postgres.Models.Event");
                    ...
                    b.ToTable("Events", t =>
                        {
                            t.Property("SubjectUserId")
                                .HasColumnName("UserListenBrainzCredentialsUpdated_SubjectUserId");
                        });

                    b.HasDiscriminator().HasValue("UserListenBrainzCredentialsUpdated");
                });
